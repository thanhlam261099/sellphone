...
namespace Lab2.Migrations
{
    ...
    [Migration("20200630032010_InitData")]
            ...
            modelBuilder.Entity("Lab2.Views.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            Color = "Black",
                            CreateDate = new DateTime(2020, 6, 30, 10, 20, 10, 585, DateTimeKind.Local).AddTicks(9233),
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Color = "Gold",
                            CreateDate = new DateTime(2020, 6, 30, 10, 20, 10, 586, DateTimeKind.Local).AddTicks(309),
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Color = "Black",
                            CreateDate = new DateTime(2020, 6, 30, 10, 20, 10, 586, DateTimeKind.Local).AddTicks(318),
                        ...
                        new
                        {
                            ...
                            CategoryId = 4,
                            Color = "Black",
                            CreateDate = new DateTime(2020, 6, 30, 10, 20, 10, 586, DateTimeKind.Local).AddTicks(320),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2dcec8ef-7a32-4597-9125-00c3b500c3f5",
                            ConcurrencyStamp = "3d9e59f0-767c-4718-a2de-f93947afcd90",
                            Name = "Visitor",
                            NormalizedName = "VISITOR"
                        },
                        new
                        {
                            Id = "a125c220-f8e4-479d-b10a-96430da4d454",
                            ConcurrencyStamp = "00203633-435b-4c36-8ce8-bb0f9ca9b8a2",
                            Name = "Administrator",
